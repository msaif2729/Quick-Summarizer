            ...
            <div className="p-5 rounded-2xl w-[80%] h-[80%] gap-5  flex flex-col lg:flex-row bg-white">
              <div className='w-full p-10 lg:w-[50%] '>
                <div className='flex gap-3 mb-5'>
                  <img src="../assets/file.png" alt="saif" />
                  <h1 className='text-2xl font-semibold text-slate-950'>Quick Summarizer</h1>
                </div>
              ...
              <div className='w-full p-10 h-full lg:w-[50%]'>
                  <h1 className='text-lg mb-3'>Sumary of Website Content</h1>
                  {
                    summary?(
